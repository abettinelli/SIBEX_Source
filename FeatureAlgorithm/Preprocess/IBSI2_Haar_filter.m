function [ImageInfo_InROIBox, BinaryMaskInfo_InROIBox]=IBSI2_Haar_filter(DataItemInfo, Param)
%%%Doc Starts%%%
%-Description:
...
%---Sanity Check
if ~isfield(Param, 'sequence') || ~isfield(Param, 'padding') || ~isfield(Param, 'type') || ~isfield(Param, 'rotation_invariance')
    ImageInfo_InROIBox=[];
...
% Low pass Kernels
ROIImageInfo = IBSI2_separable_wavelets(ROIImageInfo, Param, 'haar');

%---Summary
Summary.Type = 'IBSI2_Haar_filter';
