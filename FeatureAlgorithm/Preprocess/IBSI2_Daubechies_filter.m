function [ImageInfo_InROIBox, BinaryMaskInfo_InROIBox]=IBSI2_Daubechies_filter(DataItemInfo, Param)
%%%Doc Starts%%%
%-Description:
% DAUBECHIES WAVELET FILTERING
...
% Low pass Kernels
ROIImageInfo = IBSI2_separable_wavelets(ROIImageInfo, Param, 'daub');

%---Summary
Summary.Type = ['IBSI2_Daubechies' num2str(Param.number) '_filter'];
