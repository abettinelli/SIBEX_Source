function [ImageInfo_InROIBox, BinaryMaskInfo_InROIBox]=MaskImageEdgeRing(DataItemInfo, Param)
%%%Doc Starts%%%
%-Description: 
...
ClassStr=class(ROIImageInfo.MaskData);
FHandle=str2func(ClassStr);
ROIImageInfo.MaskData=ROIImageInfo.MaskData.*FHandle(ROIBWInfo.MaskData);
